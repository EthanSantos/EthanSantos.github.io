        ...
        <div className="max-w-md mx-auto bg-white drop-shadow-[0_0px_10px_rgba(0,0,0,0.25)] rounded-lg overflow-hidden mt-8 flex">
            <div className="px-4 py-8 flex-1">
                <div className="text-left">
                    ...
                    <p className="text-gray-600 mb-4">University of California, Irvine</p>
                    <div className="flex">
                        <a href="mailto:ethanas1@uci.edu" target="_blank">
                            <button
                                type="button"
                        ...
                        <a href="https://www.linkedin.com/in/ethanmadeit/" target="_blank">
                            <button
                                type="button"
                        ...
                        <a href="https://github.com/EthanSantos" target="_blank">
                            <button
                                type="button"
