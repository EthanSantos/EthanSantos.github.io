        ...
        <div className="min-h-screen bg-white text-black py-12">
            <div className="container mx-auto px-4 md:px-48">
                <div className="relative">
                    ...
                    <div className="md:hidden absolute left-8 h-full border-l-2 border-gray-300"></div>
                    ...
                    {experiences.map((exp, index) => (
                        ...
                        >
                            ...
                            <div className="md:hidden w-full flex">
                                ...
                                {/* Content card (mobile) */}
                                <motion.div
                                    className="flex-grow ml-4 bg-gray-100 p-6 rounded-lg shadow-lg border border-gray-300"
                            ...
                            {index % 2 === 0 ? (
                                <>
                                    ...
                                    <div className="hidden md:flex md:w-[45%] justify-end md:pr-2 relative">
                                        <motion.div
                                ...
                                <>
                                    ...
                                    <div className="hidden md:flex md:w-[45%] justify-start md:pl-2 relative">
                                        <motion.div
                                            className="bg-gray-100 p-6 rounded-lg shadow-lg border border-gray-300 w-full"
                                            initial={{ opacity: 0, y: 50 }}
                                            animate={{ opacity: 1, y: 0 }}
